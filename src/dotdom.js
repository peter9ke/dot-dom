...
/**
 * The following symbols will be available in the current scope.
 *
 * They are defined on the build targets, since the core of the library is
 * wrapped differently for each target.
 *
 * @global global      - The scope where to expose the functions
 * @global vnodeFlag   - An private instance of an anonymous symbol
 * @global globalState - A private empty object to use for state keeping
 *
 */
